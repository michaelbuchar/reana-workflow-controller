...
## [0.9.5](https://github.com/michaelbuchar/reana-workflow-controller/compare/0.9.4...0.9.5) (2026-08-19)


### Build

* **python:** pin setuptools below 81 ([#670](https://github.com/michaelbuchar/reana-workflow-controller/issues/670)) ([6e50d00](https://github.com/michaelbuchar/reana-workflow-controller/commit/6e50d0075d83665005d0ec6b4dc944314a434046))
* **python:** upgrade to Flask 3.x ([#678](https://github.com/michaelbuchar/reana-workflow-controller/issues/678)) ([332aa83](https://github.com/michaelbuchar/reana-workflow-controller/commit/332aa839f61bd145b4a16cdb28c615aa3673e554))
* **python:** use pyuwsgi for pre-built wheels ([#669](https://github.com/michaelbuchar/reana-workflow-controller/issues/669)) ([46200f6](https://github.com/michaelbuchar/reana-workflow-controller/commit/46200f6ab5338060dcd6931b5a77cd61f0d5fb60))


### Features

* **config:** propagate minimum Kubernetes job user ID env var ([#684](https://github.com/michaelbuchar/reana-workflow-controller/issues/684)) ([9bfa405](https://github.com/michaelbuchar/reana-workflow-controller/commit/9bfa405df1db33781d9fd9fc16e5e6590331a3a1))
* **dask:** add nthreads option to `dask-worker` command ([#636](https://github.com/michaelbuchar/reana-workflow-controller/issues/636)) ([eaf2b59](https://github.com/michaelbuchar/reana-workflow-controller/commit/eaf2b592679c8be5bb25b0ccb1ef9d71a6f432f9))
* **dask:** create Kerberos sidecars for Dask workflows ([#632](https://github.com/michaelbuchar/reana-workflow-controller/issues/632)) ([0f90c8a](https://github.com/michaelbuchar/reana-workflow-controller/commit/0f90c8aedd79d14528256826893591ca874d0492))
* **dask:** create Rucio sidecars for Dask workflows ([#634](https://github.com/michaelbuchar/reana-workflow-controller/issues/634)) ([89c390e](https://github.com/michaelbuchar/reana-workflow-controller/commit/89c390ea15ef37ea7522ddd8ce6357bc8620a8b8))
* **dask:** create VOMS proxy sidecars for Dask workflows ([#633](https://github.com/michaelbuchar/reana-workflow-controller/issues/633)) ([24cb362](https://github.com/michaelbuchar/reana-workflow-controller/commit/24cb362f0a7e6d49b4af6689c49590cd2cde2ad0))
* **dask:** introduce labels and node selector to Dask resources ([#628](https://github.com/michaelbuchar/reana-workflow-controller/issues/628)) ([3a8e37e](https://github.com/michaelbuchar/reana-workflow-controller/commit/3a8e37e46037f312b0f629a146f13f0f1667d041)), closes [#623](https://github.com/michaelbuchar/reana-workflow-controller/issues/623)
* **dask:** return service logs and fix service status handling ([#651](https://github.com/michaelbuchar/reana-workflow-controller/issues/651)) ([ee87fd7](https://github.com/michaelbuchar/reana-workflow-controller/commit/ee87fd73a863e17869ba3fabadacabb0af82788b)), closes [#627](https://github.com/michaelbuchar/reana-workflow-controller/issues/627)
* **docker:** externalise uWSGI controller configuration ([#683](https://github.com/michaelbuchar/reana-workflow-controller/issues/683)) ([2835455](https://github.com/michaelbuchar/reana-workflow-controller/commit/28354556f481ac20c33f69c9829a67ac2293e812))
* **k8s:** support custom namespaces for Dask resources ([#621](https://github.com/michaelbuchar/reana-workflow-controller/issues/621)) ([fbab460](https://github.com/michaelbuchar/reana-workflow-controller/commit/fbab4600076bc5d89745eaa75bfeae8ed33ab976))
* **list:** display interactive sessions ([#662](https://github.com/michaelbuchar/reana-workflow-controller/issues/662)) ([eebd278](https://github.com/michaelbuchar/reana-workflow-controller/commit/eebd2784608feb6adeaaee3ee6ef0099c5ad4b25))
* **manager:** add `user-uuid` label to runtime batch pods ([#665](https://github.com/michaelbuchar/reana-workflow-controller/issues/665)) ([f8c4f79](https://github.com/michaelbuchar/reana-workflow-controller/commit/f8c4f798f7566d4d9e38a119949839ba280ec5d8)), closes [#664](https://github.com/michaelbuchar/reana-workflow-controller/issues/664)
* **manager:** add Kueue scheduling option for user workloads ([#658](https://github.com/michaelbuchar/reana-workflow-controller/issues/658)) ([5ca4f44](https://github.com/michaelbuchar/reana-workflow-controller/commit/5ca4f4408ab3c2031484dd6d38e165fb84343e33))
* **manager:** harden workflow run and session pods ([#694](https://github.com/michaelbuchar/reana-workflow-controller/issues/694)) ([ae7f5f9](https://github.com/michaelbuchar/reana-workflow-controller/commit/ae7f5f908700749178d1ea67c12ccb855f5d8e77))
* **manager:** pass K8s requests/limits to job controller ([#643](https://github.com/michaelbuchar/reana-workflow-controller/issues/643)) ([c8a6540](https://github.com/michaelbuchar/reana-workflow-controller/commit/c8a6540bb2b2d9b4502d3350ff5dfe570ab38487))
* **manager:** pass K8s requests/limits to job controller ([#643](https://github.com/michaelbuchar/reana-workflow-controller/issues/643)) ([71aa633](https://github.com/michaelbuchar/reana-workflow-controller/commit/71aa633d83b97aa9f3a230b4845e3d27323d1bbf))
* **manager:** set runAsNonRoot on workflow-engine container ([#685](https://github.com/michaelbuchar/reana-workflow-controller/issues/685)) ([11b19db](https://github.com/michaelbuchar/reana-workflow-controller/commit/11b19dbc4a968aba56811bea2b041126f84691f0))
* **opensearch:** capture logs from Dask cluster pods ([#616](https://github.com/michaelbuchar/reana-workflow-controller/issues/616)) ([51fad95](https://github.com/michaelbuchar/reana-workflow-controller/commit/51fad95d5c7d08712e5e9b1b3f0ae055704891b2)), closes [#610](https://github.com/michaelbuchar/reana-workflow-controller/issues/610)
* **rest:** add services field to workflow endpoints ([#612](https://github.com/michaelbuchar/reana-workflow-controller/issues/612)) ([afd1400](https://github.com/michaelbuchar/reana-workflow-controller/commit/afd1400ddf79f972000830d8034e6d959afb00b3))
* **rest:** limit workspace file listing and add forced GC ([#657](https://github.com/michaelbuchar/reana-workflow-controller/issues/657)) ([dc8bb22](https://github.com/michaelbuchar/reana-workflow-controller/commit/dc8bb2220e91f85ff4bebe7bc1fc30863f56c7ce)), closes [#644](https://github.com/michaelbuchar/reana-workflow-controller/issues/644)
* **validation:** sandbox workflow specification loading ([#693](https://github.com/michaelbuchar/reana-workflow-controller/issues/693)) ([9ca3258](https://github.com/michaelbuchar/reana-workflow-controller/commit/9ca3258e644cdfaddabef3f79cdad6324375456d))


### Bug fixes

* **config:** default OpenSearch user/password to empty ([#688](https://github.com/michaelbuchar/reana-workflow-controller/issues/688)) ([f6343b6](https://github.com/michaelbuchar/reana-workflow-controller/commit/f6343b68c178d03039c3c838af6207431c99b890))
* **config:** harmonise and align REANA host port handling ([#680](https://github.com/michaelbuchar/reana-workflow-controller/issues/680)) ([5b6742d](https://github.com/michaelbuchar/reana-workflow-controller/commit/5b6742deb4db1dca1c9f865396588de5bd9a6837))
* **config:** refuse running with an unset SECRET_KEY ([#688](https://github.com/michaelbuchar/reana-workflow-controller/issues/688)) ([7b1fbd3](https://github.com/michaelbuchar/reana-workflow-controller/commit/7b1fbd3c6385976745c88eefb63d412082652101))
* **config:** update reana-auth-vomsproxy to 1.3.1 to fix WLCG IAM ([#639](https://github.com/michaelbuchar/reana-workflow-controller/issues/639)) ([12a9742](https://github.com/michaelbuchar/reana-workflow-controller/commit/12a9742178db1ac7a0c3100a61ea23560471c2c7))
* **config:** use glob for egg-info in flake8 exclude ([#650](https://github.com/michaelbuchar/reana-workflow-controller/issues/650)) ([8092761](https://github.com/michaelbuchar/reana-workflow-controller/commit/809276132a101ac40b8bd26f105286155f9fc45f))
* **consumer:** bypass kubernetes 36 pod log deserialiser ([#689](https://github.com/michaelbuchar/reana-workflow-controller/issues/689)) ([895b55e](https://github.com/michaelbuchar/reana-workflow-controller/commit/895b55e3b9abe813524e86ec026850ddc3298089))
* **dask:** catch cleanup errors on cluster creation failures ([#676](https://github.com/michaelbuchar/reana-workflow-controller/issues/676)) ([abfaad7](https://github.com/michaelbuchar/reana-workflow-controller/commit/abfaad7e63fa32cbb4f5297030e9b8539afe00c7))
* **dask:** check Traefik before creating dashboard ingress ([#629](https://github.com/michaelbuchar/reana-workflow-controller/issues/629)) ([bb7b2ff](https://github.com/michaelbuchar/reana-workflow-controller/commit/bb7b2ff2b23c169b2209c88bf1bc24aaa4021e9e))
* **dask:** create group-writable worker files ([#695](https://github.com/michaelbuchar/reana-workflow-controller/issues/695)) ([0654955](https://github.com/michaelbuchar/reana-workflow-controller/commit/065495532407579dc31eb1468c63d4b11d5324e7))
* **dask:** fix pulling from private container registries ([#677](https://github.com/michaelbuchar/reana-workflow-controller/issues/677)) ([b6eafc5](https://github.com/michaelbuchar/reana-workflow-controller/commit/b6eafc5177b7ca819118753318b4491f6f2ff6cd))
* **dask:** respect runtime namespace when deleting Dask clusters ([#675](https://github.com/michaelbuchar/reana-workflow-controller/issues/675)) ([fb48ea3](https://github.com/michaelbuchar/reana-workflow-controller/commit/fb48ea3f1b2e5d74c9d533df4579da273c5d98fb))
* **dask:** use correct REANA host port for Dask service URLs ([#630](https://github.com/michaelbuchar/reana-workflow-controller/issues/630)) ([a02767e](https://github.com/michaelbuchar/reana-workflow-controller/commit/a02767ea9fe781c4f4a58c13f4420498bd760a0d))
* **factory:** initialise umask during app startup ([#695](https://github.com/michaelbuchar/reana-workflow-controller/issues/695)) ([d1ec042](https://github.com/michaelbuchar/reana-workflow-controller/commit/d1ec042f61bc3e64c8f9f1d5223cbb64ffb0a737))
* **git:** update .gitignore to exclude modules directory ([#687](https://github.com/michaelbuchar/reana-workflow-controller/issues/687)) ([c797ed0](https://github.com/michaelbuchar/reana-workflow-controller/commit/c797ed0a1f67b7b315ce5eba9a54612827509ff1))
* **k8s:** check readiness of Dask service pods ([#626](https://github.com/michaelbuchar/reana-workflow-controller/issues/626)) ([2797300](https://github.com/michaelbuchar/reana-workflow-controller/commit/279730051ecf3ad21d55f57c899cc574d40fe503)), closes [#625](https://github.com/michaelbuchar/reana-workflow-controller/issues/625)
* **k8s:** improve error handling for Dask K8s resources ([#618](https://github.com/michaelbuchar/reana-workflow-controller/issues/618)) ([a71ad83](https://github.com/michaelbuchar/reana-workflow-controller/commit/a71ad83310c6dc880da6d33531a3ccc528c3d7a6)), closes [#617](https://github.com/michaelbuchar/reana-workflow-controller/issues/617)
* **python:** replace deprecated V1Handler with V1LifecycleHandler ([#672](https://github.com/michaelbuchar/reana-workflow-controller/issues/672)) ([942a313](https://github.com/michaelbuchar/reana-workflow-controller/commit/942a313440dbe198b70bbbf75951d7afa620da0e))
* **rest:** correct response when fetching workflow logs by steps ([#660](https://github.com/michaelbuchar/reana-workflow-controller/issues/660)) ([9880f76](https://github.com/michaelbuchar/reana-workflow-controller/commit/9880f76ee8dc8dd37867a00b7174f4fa60c3ab47)), closes [#659](https://github.com/michaelbuchar/reana-workflow-controller/issues/659)
* **rest:** detect session status from the pod state ([#611](https://github.com/michaelbuchar/reana-workflow-controller/issues/611)) ([907459b](https://github.com/michaelbuchar/reana-workflow-controller/commit/907459b75ee9aaa9ef028f641e14d1f875b7729a))


### Code refactoring

* **dask:** use central function for Dask K8s component names ([#613](https://github.com/michaelbuchar/reana-workflow-controller/issues/613)) ([f252098](https://github.com/michaelbuchar/reana-workflow-controller/commit/f252098250257ea9d513b9c7c850cfdca97aa39c))
* **pytest:** drop pytest-reana for reana-commons[tests] ([#681](https://github.com/michaelbuchar/reana-workflow-controller/issues/681)) ([99f9d86](https://github.com/michaelbuchar/reana-workflow-controller/commit/99f9d86a6e1947dd8b55bd23f875d083d74f5291))
* **rest:** adapt to non-dynamic relationships ([#679](https://github.com/michaelbuchar/reana-workflow-controller/issues/679)) ([9b15870](https://github.com/michaelbuchar/reana-workflow-controller/commit/9b158702893d1af4747b8a5291b12a185c670273))


### Code style

* **python:** adapt code base to the new black version ([#670](https://github.com/michaelbuchar/reana-workflow-controller/issues/670)) ([e2cdbad](https://github.com/michaelbuchar/reana-workflow-controller/commit/e2cdbadbe13aaeaae7b7d36fa8e1a0a1ef0e8c70))


### Continuous integration

* **commitlint:** consider commit body full stop as warning ([#643](https://github.com/michaelbuchar/reana-workflow-controller/issues/643)) ([c8a6540](https://github.com/michaelbuchar/reana-workflow-controller/commit/c8a6540bb2b2d9b4502d3350ff5dfe570ab38487))
* **commitlint:** consider commit body full stop as warning ([#643](https://github.com/michaelbuchar/reana-workflow-controller/issues/643)) ([ee9210e](https://github.com/michaelbuchar/reana-workflow-controller/commit/ee9210e4ecc834d79c721ac68dd99427ef206b78))
* **commitlint:** fix local running of commit linter on macOS ([#656](https://github.com/michaelbuchar/reana-workflow-controller/issues/656)) ([d939f25](https://github.com/michaelbuchar/reana-workflow-controller/commit/d939f2517f995e2dde8ad0737290f517bad19429))
* **jsonlint:** add JSON linting ([#655](https://github.com/michaelbuchar/reana-workflow-controller/issues/655)) ([f095249](https://github.com/michaelbuchar/reana-workflow-controller/commit/f0952492779267cda3511139ef7f0fb081e300b8))
* **markdownlint:** add Markdown linting ([#655](https://github.com/michaelbuchar/reana-workflow-controller/issues/655)) ([d9e6442](https://github.com/michaelbuchar/reana-workflow-controller/commit/d9e64423219f4936796fb6762a3b79d88ae48f6b))
* **markdownlint:** less permissive global configuration ([#672](https://github.com/michaelbuchar/reana-workflow-controller/issues/672)) ([ce03f12](https://github.com/michaelbuchar/reana-workflow-controller/commit/ce03f1250b0bf77d1d501ce2dfbaadaf98d61436))
* **prettier:** add Prettier code formatting checks ([#655](https://github.com/michaelbuchar/reana-workflow-controller/issues/655)) ([2c339b7](https://github.com/michaelbuchar/reana-workflow-controller/commit/2c339b7feb6d7d5dea1e658ae7fb63872076082f))
* **run-tests:** add usage help and refactor options ([#672](https://github.com/michaelbuchar/reana-workflow-controller/issues/672)) ([e4495aa](https://github.com/michaelbuchar/reana-workflow-controller/commit/e4495aa3f71544e2e63a357a6da0db243169d606))
* **run-tests:** improve old DB container cleanup ([#678](https://github.com/michaelbuchar/reana-workflow-controller/issues/678)) ([2ac3c32](https://github.com/michaelbuchar/reana-workflow-controller/commit/2ac3c32633792a9ab0c4cebf54d4fb9d5e6b470a))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#647](https://github.com/michaelbuchar/reana-workflow-controller/issues/647)) ([c8a6540](https://github.com/michaelbuchar/reana-workflow-controller/commit/c8a6540bb2b2d9b4502d3350ff5dfe570ab38487))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#647](https://github.com/michaelbuchar/reana-workflow-controller/issues/647)) ([2b004ce](https://github.com/michaelbuchar/reana-workflow-controller/commit/2b004ce78456a31f398bbd9deb43b52f028f2d3a))
* **shfmt:** add shfmt code formatting checks ([#654](https://github.com/michaelbuchar/reana-workflow-controller/issues/654)) ([992506f](https://github.com/michaelbuchar/reana-workflow-controller/commit/992506fc9386134e996917612e9e1abd2211ea1e)), closes [#652](https://github.com/michaelbuchar/reana-workflow-controller/issues/652)
* **yamllint:** add YAML linting ([#655](https://github.com/michaelbuchar/reana-workflow-controller/issues/655)) ([0e1837d](https://github.com/michaelbuchar/reana-workflow-controller/commit/0e1837dc3b7a42dbc9b71a5a59c5e6fd15569056))
